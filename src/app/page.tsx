...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="custom-scrollbar-2 mx-auto w-full pt-[30px] ">
        ...
        <Header />
        <main className="custom-scrollbar-2 mx-auto  min-h-[calc(100vh_-_var(--header-height))]  pl-10 pr-10 pt-[76px] md:pl-0">
        ...
        >
          ...
          <div className="relative flex w-full  justify-between gap-5  pt-20 font-creato uppercase">
            <p className="text-left basis-1/3">idea&design&illustration: margarita golubeva</p>
            <p className="text-center basis-1/3">.2024</p>

            <p className="text-right basis-1/3">Ⓒ lolafel by: butcher studio</p>
