...
export default function Home() {
  return (
    <>
      ...
      {/* <div className="custom-scrollbar-2 relative z-[11] min-h-screen w-full  pt-[30px] md:w-auto md:overflow-hidden"> */}
      <div className="custom-scrollbar-2 relative z-[11] w-full overflow-hidden pt-[30px] md:w-auto md:overflow-hidden">
        <Header />
        {/* </div> */}
        <main className="custom-scrollbar-2 relative mx-auto flex  flex-col   px-2.5  pt-[7vh] xl:px-5 xl:pt-[60px] 2xl:px-10 2xl:pt-[76px]">
          ...
          <div className=" relative z-20 mx-auto flex flex-col items-center justify-center  gap-[2vh] pb-[35px] text-center  md:max-w-fit xl:gap-0">
          ...
          <div className="relative z-20 flex  items-center justify-center ">
            ...
            <Image
              src={falafelMain1920}
              alt="falafel image"
              className="z-10 mx-auto hidden min-w-[950px] max-w-[1322px]  2xl:block"
            ...
            <Image
              src={falafelMobile}
              alt="falafel image"
              className="z-10 mx-auto min-w-[655px] max-w-[100vw]   md:hidden"
              // className="absolute bottom-[calc(var(--main-page-padding-bottom)_-_20px)] right-[50%] z-10 min-w-[80vh] translate-x-1/2  md:hidden "
            />
            {/* </div> */}
            ...
            <div className="absolute right-1/2 top-[28vh] z-20 hidden w-full max-w-[1036px] translate-x-1/2 items-center justify-center font-creato text-[14px] uppercase xl:flex 2xl:max-w-[1450px] 2xl:text-[18px]">
              <div className="flex w-full   items-center justify-between 2xl:max-w-[1420px]">
