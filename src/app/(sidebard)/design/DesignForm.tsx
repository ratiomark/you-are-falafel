...
const defaultValues: Partial<ProjectFormData> = {
  ...
  primaryFontType: 'Geneva',
  // secondaryFontType: 'Webdings',
  primaryFontColor: '#80A8AE',
  primaryColor: '#80A8AE',
  secondaryFontColor: '#80A8AE',
  storyHeaderFontColor: '#80A8AE',
}
// const defaultValues = {
// 	primaryFontType: '',
// 	primaryFontColor: '',
  ...
  return (
    <Form {...form}>
      ...
      <form
        ...
        className="flex w-full flex-col gap-10 scroll-smooth pb-20"
      >
